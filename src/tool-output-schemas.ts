...
export const imageBriefOutputSchema = {
  ...
  properties: {
    ...
    designReview: { type: "object", description: "Automated design failures plus pending visual criteria. No automated visual pass is issued." },
    ...
    mapSvg: { type: "string", description: "Deterministic draft map using the blueprint road paths, pictograms and literal labels. Also returned as the second PNG." },
    facts: { type: "object", required: ["destination", "landmarks", "roads", "sharedNodes", "displayRoads", "displayNodes", "roadContinuities", "roadRelations", "requestedStart"],
      additionalProperties: false, properties: {
        orientation: { type: "object", description: "Single rigid rotation from north-up shared by all source anchors and road paths." },
